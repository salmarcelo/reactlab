...
function Form() {
    ...
    //useEffect(() => {
        //axios.get('http://localhost:3031/estados')
          //  .then(response => {
    ...
    function handleFormSubmit(event){
        ...
        //  axios.post('http://localhost:3030/cadastro', campos).then(response => {
        ...
        <div>
            ...
            <form onSubmit={handleFormSubmit}>
                <fieldset>
                    ...
                    <div>
                        <label>UF:
                        <input type="text" name="txtUF" id="txtUF" onChange={handleInputChange} />
